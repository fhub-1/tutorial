      ...
      <div className="bg-hero  h-[712px] bg-repeat-">
        <div className="container mx-auto">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 mx-auto text-gray-700 text-opacity-60 text-lg  w-4/12 leading-relaxed">Since 15 years I started programming. Since 3 years starting UI design.</p>
