      ...
      <div className="bg-hero  h-[700px] bg-repeat-round">
        <div className="container mx-auto">
          ...
          <div className="text-center mt-18">
            ...
            <p className="text-black text-opacity-60 text-lg mt-6 mx-auto w-4/12 leading-relaxed">Since 17 years I started programming. Since 19 years starting UI design.</p>
            <Button variant="yellow" className="mb-16">Learn More</Button>  
          </div>
          </div>
      </div>
      {/* end of the hero */}
